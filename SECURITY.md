...
- Preferred: open a [GitHub private security advisory](https://github.com/mstuart/tare/security/advisories/new).
- Or email: **stuartmark@gmail.com**
...
tare's proxy sits in the request path and **forwards your provider API key** (`x-api-key` /
